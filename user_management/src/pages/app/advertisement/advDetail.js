...
import { IMG_BASE_URL, ORBASE_URL,API_ENDPOINTS_ADV, JEW_IMG_BASE_URL } from "../../../services/api_url";
  ...
  async function getDetail(data) {
    try {
      const result = await axios.get(
        // `http://back.persianjewishhistory.com/api/Advertisement/Get-Advertisement-By-Id?Id=${data}`

          `${API_ENDPOINTS_ADV.get_id_adv}?Id=${data}`
      );
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex" }}>
            ...
            <div>
              <img
                src={JEW_IMG_BASE_URL + info.imagePath}
