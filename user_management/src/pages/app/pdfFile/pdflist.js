...
export const PdfList = () => {
  ...
  const getAllPDFDetails = async () => {
    ...
    const result = await axiosInstance.get(
      `${API_ENDPOINTS_Files.get_all_files}`
    );
    if (result.data) {
      setIsloading(false);
    ...
    try {
      axiosInstance
        .post(
          ...
          `${API_ENDPOINTS_Files.delete_file}?Id=${id}`
        )
        .then((res) => {
          ...
          <Table sx={{ width: "1250px" }} aria-label="customized table">
            <TableHead>
              <TableRow>
                ...
                <StyledTableCell>NoOFPages </StyledTableCell>
                <StyledTableCell>Description </StyledTableCell>
                <StyledTableCell align="center">File Name</StyledTableCell>
                <StyledTableCell align="start">publishedYear</StyledTableCell>
